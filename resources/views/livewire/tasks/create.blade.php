<div>
    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 bg-white dark:bg-gray-800">
            <h2 class="text-2xl font-semibold text-gray-800 dark:text-white mb-6">Create New Task</h2>

            <form wire:submit="save">
                <div class="mb-4">
                    <label for="project_id" class="block text-gray-700 dark:text-gray-300 text-sm font-bold mb-2">
                        Project *
                    </label>
                ...
                <div class="grid grid-cols-3 gap-4 mb-4">
                    ...
                    <div>
                        <label for="priority" class="block text-gray-700 dark:text-gray-300 text-sm font-bold mb-2">
                            Priority *
                        </label>
